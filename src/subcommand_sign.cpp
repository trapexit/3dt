...
enum
  {
    ...
    APPSPLASH_NTSC_SIZE_W_SIG = APPSPLASH_NTSC_SIZE + APPSPLASH_SIG_SIZE,
    APPSPLASH_PAL_SIZE = ((352 * 288 * 2) + APPSPLASH_HDR_SIZE),
    APPSPLASH_PAL_SIZE_W_SIG = APPSPLASH_PAL_SIZE + APPSPLASH_SIG_SIZE,    
  };
